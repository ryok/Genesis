...
def evaluate_terrain(terrain_type: str, difficulty: int, max_steps: int = 1000):
    """地形評価を実行"""
...
def main():
    ...
    if args.all_levels:
        ...
        results = {}
        for level in [1, 2, 3]:
            results[level] = evaluate_terrain(args.terrain, level, args.max_steps)
        ...
        # 単一レベル評価
        result = evaluate_terrain(args.terrain, args.difficulty, args.max_steps)
